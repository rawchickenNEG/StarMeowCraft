...
public class LifeCycle extends Enchantment {
    public LifeCycle(Rarity rarity) {
    ...
    public boolean checkCompatibility(Enchantment p_44590_) {
        return !(p_44590_ instanceof CompositeFertilizer) && super.checkCompatibility(p_44590_);
    }
}
