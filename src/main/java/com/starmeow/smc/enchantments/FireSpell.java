...
public class FireSpell extends Enchantment {
    public FireSpell(Enchantment.Rarity rarity) {
    ...
    public boolean checkCompatibility(Enchantment p_45113_) {
        return super.checkCompatibility(p_45113_) && p_45113_ != EnchantmentRegistry.FREEZE_SPELL.get() && p_45113_ != EnchantmentRegistry.LIGHTNING_SPELL.get();
    }
}
