...
public class FreezeSpell extends Enchantment {
    public FreezeSpell(Rarity rarity) {
    ...
    public boolean checkCompatibility(Enchantment p_45113_) {
        return super.checkCompatibility(p_45113_) && p_45113_ != EnchantmentRegistry.FIRE_SPELL.get() && p_45113_ != EnchantmentRegistry.LIGHTNING_SPELL.get();
    }
}
