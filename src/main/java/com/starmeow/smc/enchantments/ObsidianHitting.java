...
public class ObsidianHitting extends Enchantment {
    public ObsidianHitting(Rarity rarity) {
    ...
    public boolean checkCompatibility(Enchantment p_44590_) {
        return !(p_44590_ instanceof InfernoHitting) && !(p_44590_ instanceof EnderFloating) && super.checkCompatibility(p_44590_);
    }
}
