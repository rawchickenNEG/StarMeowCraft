...
public class EnderFloating extends Enchantment {
    public EnderFloating(Rarity rarity) {
    ...
    public boolean checkCompatibility(Enchantment p_44590_) {
        return !(p_44590_ instanceof InfernoHitting) && !(p_44590_ instanceof ObsidianHitting) && super.checkCompatibility(p_44590_);
    }
}
