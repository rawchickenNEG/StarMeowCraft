...
public class DivineJudgement extends Enchantment {
    public DivineJudgement(Rarity rarity) {
        super(rarity, EnchantmentRegistry.EXCALIBUR, new EquipmentSlot[] {EquipmentSlot.MAINHAND});
    }
