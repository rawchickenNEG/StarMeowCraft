...
public class CompositeFertilizer extends Enchantment {
    public CompositeFertilizer(Rarity rarity) {
        super(rarity, EnchantmentRegistry.WATERING_CAN, new EquipmentSlot[] {EquipmentSlot.MAINHAND});
    }
    ...
    public boolean checkCompatibility(Enchantment p_44590_) {
        return !(p_44590_ instanceof LifeCycle) && super.checkCompatibility(p_44590_);
    }
}
