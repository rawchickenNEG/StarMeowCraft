...
public class SpearGun extends FishingRodItem {
    public SpearGun(Properties p_41285_) {
        super(p_41285_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41290_, Player p_41291_, InteractionHand p_41292_) {
        ...
        if (p_41291_.fishing != null) {
            ...
            p_41290_.playSound((Player)null, p_41291_.getX(), p_41291_.getY(), p_41291_.getZ(), SoundEvents.CROSSBOW_LOADING_END, SoundSource.NEUTRAL, 1.0F, 0.4F / (p_41290_.getRandom().nextFloat() * 0.4F) + 0.8F);
            p_41291_.gameEvent(GameEvent.ITEM_INTERACT_FINISH);
        } else {
            p_41290_.playSound((Player)null, p_41291_.getX(), p_41291_.getY(), p_41291_.getZ(), SoundEvents.CROSSBOW_SHOOT, SoundSource.NEUTRAL, 0.5F, 0.4F / (p_41290_.getRandom().nextFloat() * 0.4F) + 0.8F);
            if (!p_41290_.isClientSide) {
                p_41290_.addFreshEntity(new SpearHook(p_41291_, p_41290_));
            }
