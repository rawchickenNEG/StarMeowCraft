...
public class BroccoliFishingRod extends FishingRodItem {
    public BroccoliFishingRod(Properties p_41285_) {
        super(p_41285_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_41290_, Player p_41291_, InteractionHand p_41292_) {
        ...
        if (p_41291_.fishing != null) {
            ...
            if (!p_41290_.isClientSide) {
                int k = EnchantmentHelper.getFishingSpeedBonus(itemstack) * 2 + 1;
                int j = EnchantmentHelper.getFishingLuckBonus(itemstack) * 2 + 1;
                p_41290_.addFreshEntity(new BroccoliFishingHook(p_41291_, p_41290_, j, Math.max(k, 5)));
            }
