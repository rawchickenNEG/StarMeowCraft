...
public class PerfrostiteBow extends BowItem {
    public PerfrostiteBow(Properties p_40660_) {
        super(p_40660_);
    }
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!p_40668_.isClientSide) {
                        ...
                        for (AbstractArrow arrow : arrows){
                            ...
                            if (flag && (itemstack.is(ItemRegistry.FROST_ARROW.get()) || itemstack.is(Items.SPECTRAL_ARROW))){
                                arrow.pickup = AbstractArrow.Pickup.CREATIVE_ONLY;
                            }
                            if(s > 0){
                            ...
                            arrow.shootFromRotation(player, player.getXRot(), player.getYRot(), 0.0F, f * 3.3F - 0.3F * s, 1.0F);
                    ...
                    if (!flag1 && !player.getAbilities().instabuild && !(flag && itemstack.is(ItemRegistry.FROST_ARROW.get())) && !(flag && itemstack.is(Items.SPECTRAL_ARROW))) {
                        itemstack.shrink(1);
                        if (itemstack.isEmpty()) {
