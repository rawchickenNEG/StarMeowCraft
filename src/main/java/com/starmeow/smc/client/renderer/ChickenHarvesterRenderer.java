...
@OnlyIn(Dist.CLIENT)
public class ChickenHarvesterRenderer extends MobRenderer<ChickenHarvester, ChickenHarvesterModel<ChickenHarvester>> {
    ...
    public ResourceLocation getTextureLocation(ChickenHarvester p_113998_) {
        return LOCATION;
    }

    protected float getBob(ChickenHarvester p_114000_, float p_114001_) {
