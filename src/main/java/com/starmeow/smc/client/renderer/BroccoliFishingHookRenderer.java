...
import com.starmeow.smc.entities.projectiles.BroccoliFishingHook;
...
@OnlyIn(Dist.CLIENT)
public class BroccoliFishingHookRenderer extends EntityRenderer<BroccoliFishingHook> {
    ...
    public BroccoliFishingHookRenderer(EntityRendererProvider.Context p_174117_) {
        super(p_174117_);
    }

    public void render(BroccoliFishingHook p_114705_, float p_114706_, float p_114707_, PoseStack p_114708_, MultiBufferSource p_114709_, int p_114710_) {
    ...
    public ResourceLocation getTextureLocation(BroccoliFishingHook p_114703_) {
